...
| 장당 단가 · 월 무료량 · RPM · 가입 요건(카드/중국 실명) | ❌ **미확인** — 문서 사이트가 막힘 |
...
1. 위 **미확인 칸**(단가·무료량·RPM·가입 요건)을 문서에서 확인 → 이 표에 채움
2. 공급사 **1곳(최대 2곳)** 선택 → 계정·결제
3. 키가 오면 D0-3(12장 채점) — 콘솔 임시 화면에 원본/번역 나란히
