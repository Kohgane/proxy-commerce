...
| Phase 171 | 파비콘 v11 우주/네온 교체 — 운영 `favicon.svg`를 우주(거의 검정) 배경 + 네온 골드/라임 궤도선 + 트리플 글로우 지구본 + 별/스파클 확정안으로 교체, `favicon.ico`(16/32/48 소형 단순화)·apple-touch·icon-192·icon-512 재생성, manifest/head theme-color `#020010` 및 캐시버스팅 `?v=171` 갱신 | #PR | 2026-06-04 |
| Phase 170 | 셀러 콘솔 실동작화 1차 — AI 상품등록 가격결정에서 합성 시장가 제거(실측 데이터 없으면 제외), 마진 기반 권장가 우선·출처 라벨 분해, URL 스크래퍼 KRW 표시가 우선/세일·정가 분리, 갤러리 원본 이미지 다중 추출 강화(srcset/data-srcset/data-zoom), 키워드 트렌드/최적화 라우트 실동작화 및 빈 상태 처리 | #PR | 2026-06-04 |
...
| Phase 101 | 자동 구매 엔진 v2 (오케스트레이션, 소스선택, 마켓플레이스 구매, 결제, 모니터링, 규칙엔진) | #67 | 2026-04-06 |
| Phase 102 | 배송대행지 연동 (몰테일/이하넥스 API, 입고 확인, 합배송, 비용 견적) | #68 | 2026-04-06 |
| Phase 103 | 풀필먼트 자동화 (검수/포장/국내택배 발송/운송장 자동등록/배송추적) | #69 | 2026-04-06 |
| Phase 104 | 타오바오/1688 자동 구매 규격 (에이전트 API, RPA, 셀러 검증, 중국 결제) | #70 | 2026-04-06 |
...
| Phase 140 | 가격 자동 조정 + 경쟁사 모니터링 + 마진 가드 + 환율 변동 대응 | #PR | 2026-05-08 |
| Phase 141 | Hotfix(영속성 통일/헤더/scheduler 가시성) + BI 분석 대시보드 | #PR | 2026-05-09 |
| Phase 142 | 인증/권한 hotfix + 자동 리오더 + 할인 캠페인 자동화 | #PR | 2026-05-10 |
| Phase 143 | 소싱 파이프라인 자동화 + 상품 등록 자동화 + 이미지/번역 품질 향상 | #PR | 2026-05-10 |
| Phase 144 | 라우트 등록 hotfix + 광고 자동 운영 + 키워드 입찰 최적화 | #PR | 2026-05-10 |
